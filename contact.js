 ...
 * - Mobile drawer, language: script.js
...
(function () {
  ...
  /* ============================================================
     Phone Input — digits only + auto-focus next field
  ============================================================ */
  var telInputs = document.querySelectorAll('.cform-tel');
  telInputs.forEach(function (input, idx) {
    input.addEventListener('input', function () {
      /* Strip non-digit characters */
      this.value = this.value.replace(/\D/g, '');
      /* Auto-move to next input on max length */
      if (this.value.length >= parseInt(this.maxLength, 10) && idx < telInputs.length - 1) {
        telInputs[idx + 1].focus();
      }
    });
  ...
  if (form) {
    ...
    form.addEventListener('submit', async function (e) {
      ...
      var tel1        = (document.getElementById('fieldTel1')        || {}).value || '';
      var tel2        = (document.getElementById('fieldTel2')        || {}).value || '';
      var tel3        = (document.getElementById('fieldTel3')        || {}).value || '';
